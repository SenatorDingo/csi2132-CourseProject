...
<body>
<%
    // Fetch employeeID parameter and bookings list
    ...
    <div class="table-responsive mt-4">
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td>
                    <a href="CheckInServlet?book=<%= booking.getBookingID() %>&employeeID=<%= employeeID %>" class="btn btn-success btn-sm">Check In</a>
                </td>
                <td>
                    <a href="edit-bookings.jsp?book=<%= booking.getBookingID() %>&employeeID=<%= employeeID %>" class="btn btn-warning btn-sm">Edit</a>
                </td>
            </tr>
            <% } %>
            </tbody>
